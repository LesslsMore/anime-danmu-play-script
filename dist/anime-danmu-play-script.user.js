...
(function (Dexie) {
  ...
  function create_button() {
    ...
    button.addEventListener("click", async () => {
      ...
      const playUrls2 = JSON.parse("['https://anime-danmu.onrender.com/danmu', 'https://anime-danmu-play.vercel.app/danmu', 'https://anime-danmu.vercel.app/danmu']".replace(/'/g, '"'));
  ...
  const playUrls = JSON.parse("['https://anime-danmu.onrender.com/danmu', 'https://anime-danmu-play.vercel.app/danmu', 'https://anime-danmu.vercel.app/danmu']".replace(/'/g, '"'));
